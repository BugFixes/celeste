...
import (
	database "github.com/bugfixes/celeste/internal/database"
...
func (_m *TicketingSystem) TicketExists(_a0 ticketing.Ticket) (bool, database.TicketDetails, error) {
	...
	var r1 database.TicketDetails
	if rf, ok := ret.Get(1).(func(ticketing.Ticket) database.TicketDetails); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Get(1).(database.TicketDetails)
	}
